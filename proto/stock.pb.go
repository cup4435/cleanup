...
func (x *StockRequest) GetTicker() string {
	if x != nil {
		return x.Ticker
	}
	return ""
...
const file_stock_proto_rawDesc = "" +
	...
	"\x06status\x18\x03 \x01(\tR\x06status2E\n" +
	"\fStockService\x125\n" +
	"\bGetStock\x12\x13.stock.StockRequest\x1a\x14.stock.StockResponseB\tZ\a./protob\x06proto3"
...
var file_stock_proto_depIdxs = []int32{
	0, // 0: stock.StockService.GetStock:input_type -> stock.StockRequest
	1, // 1: stock.StockService.GetStock:output_type -> stock.StockResponse
